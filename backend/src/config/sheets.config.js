...
export const SHEET_SCHEMAS = {
  ...
  "Nhân sự": {
    fields: {
      ...
      leader: column(["Đội trưởng", "Tên đội trưởng", "Đội trưởng / Họ và tên", "Đội trưởng/Họ và tên"], { required: false }),
      visible: column(["Hiển thị (dành cho dashboard)", "Hiển thị dashboard", "Hiển thị"], { required: false }),
